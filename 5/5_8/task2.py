...
какие действия могут быть выполнены в рамках системы. Разрешения могут ограничивать использование
определенного программного обеспечения, доступ к файлам и настройки системы безопасности.
Давайте мы создадим миксин, который имитирует управления правами доступами.
